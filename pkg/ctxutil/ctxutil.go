...
// SetDistrict sets district into context
func SetDistrict(ctx context.Context, district string) context.Context {
	return context.WithValue(ctx, districtKey, district)
}

// GetDistrict gets district from context,
// if district not exists, ErrNotExist will be returned
func GetDistrict(ctx context.Context) (string, error) {
	return getString(ctx, districtKey)
}

// SetPassengerID sets passengerID into context
func SetPassengerID(ctx context.Context, passengerID int64) context.Context {
	return context.WithValue(ctx, passengerIDKey, passengerID)
}

// GetPassengerID gets passengerID from context,
// if passengerID not exists, ErrNotExist will be returned
func GetPassengerID(ctx context.Context) (int64, error) {
	return getInt64(ctx, passengerIDKey)
}

// SetDriverID sets driverID into context
func SetDriverID(ctx context.Context, driverID int64) context.Context {
	return context.WithValue(ctx, driverIDKey, driverID)
}

// GetDriverID gets driverID from context,
// if driverID not exists, ErrNotExist will be returned
func GetDriverID(ctx context.Context) (int64, error) {
	return getInt64(ctx, driverIDKey)
}

// SetOrderID sets orderID into context
func SetOrderID(ctx context.Context, orderID int64) context.Context {
	return context.WithValue(ctx, orderIDKey, orderID)
}

// GetOrderID gets orderID from context,
// if orderID not exists, ErrNotExist will be returned
func GetOrderID(ctx context.Context) (int64, error) {
	return getInt64(ctx, orderIDKey)
}

// SetDBTime initialize the time counter for database
